...
- Usage: Reference from command with `@C:/Projeler/ELM-tool/.augment/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/Projeler/ELM-tool/.augment/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Projeler/ELM-tool/.augment/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
