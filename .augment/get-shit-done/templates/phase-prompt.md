...
<!-- For checkpoint task examples and patterns, see @C:/Projeler/ELM-tool/.augment/get-shit-done/references/checkpoints.md -->
...
See `C:/Projeler/ELM-tool/.augment/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `C:/Projeler/ELM-tool/.augment/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `C:/Projeler/ELM-tool/.augment/get-shit-done/workflows/verify-phase.md` for verification logic.
