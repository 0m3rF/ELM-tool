...
```bash
INIT=$(node "C:/Projeler/ELM-tool/.augment/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Projeler/ELM-tool/.augment/get-shit-done/templates/spec.md.
