...
```
Task(
  prompt="Read C:/Projeler/ELM-tool/.augment/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Projeler/ELM-tool/.augment/get-shit-done/templates/VALIDATION.md`
