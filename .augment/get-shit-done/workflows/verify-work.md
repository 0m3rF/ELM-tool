...
<template>
@C:/Projeler/ELM-tool/.augment/get-shit-done/templates/UAT.md
</template>
...
Read and follow `C:/Projeler/ELM-tool/.augment/get-shit-done/workflows/transition.md`.
...
```bash
node "C:/Projeler/ELM-tool/.augment/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @C:/Projeler/ELM-tool/.augment/get-shit-done/workflows/diagnose-issues.md
