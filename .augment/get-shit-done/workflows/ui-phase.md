...
```markdown
Read C:/Projeler/ELM-tool/.augment/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/Projeler/ELM-tool/.augment/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/Projeler/ELM-tool/.augment/agents/gsd-ui-checker.md for instructions.
