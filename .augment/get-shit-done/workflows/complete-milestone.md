...
```bash
node "C:/Projeler/ELM-tool/.augment/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `C:/Projeler/ELM-tool/.augment/get-shit-done/templates/retrospective.md`.
