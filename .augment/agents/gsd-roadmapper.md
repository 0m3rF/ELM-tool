...
Reference full template: `C:/Projeler/ELM-tool/.augment/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/Projeler/ELM-tool/.augment/get-shit-done/templates/state.md`.
