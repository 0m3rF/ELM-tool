...
<reference>
@C:/Projeler/ELM-tool/.augment/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Projeler/ELM-tool/.augment/get-shit-done/references/user-profiling.md` to load:
